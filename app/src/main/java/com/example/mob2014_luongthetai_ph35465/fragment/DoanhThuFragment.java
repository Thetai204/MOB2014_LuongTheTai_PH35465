...
import com.example.mob2014_luongthetai_ph35465.dao.ThongKeDAO;
...
public class DoanhThuFragment extends Fragment {
    ...
    private void initUI(View view) {
        btn_tungay = view.findViewById(R.id.bnt_tuNgay);
        btn_denngay = view.findViewById(R.id.bnt_denNgaY);
        btn_doanhthu = view.findViewById(R.id.btn_thongKe);

        edt_tungay = view.findViewById(R.id.tv_tuNgay);
        edt_denngay = view.findViewById(R.id.tv_denNgay);
