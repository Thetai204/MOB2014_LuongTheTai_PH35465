...
import com.example.mob2014_luongthetai_ph35465.adapter.LoaiSachAdapter;
...
public class LoaiSachFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ql_loai, container, false);
    ...
    protected void openDialog(final Context context, final int type) {
        ...
        edt_maloai = dialog.findViewById(R.id.txtMaloai_loai);
        edt_tenLoai = dialog.findViewById(R.id.txtTenloai_loai);
        Button btn_cancel = dialog.findViewById(R.id.btnCancelLoai);
        Button btn_save = dialog.findViewById(R.id.btnSaveLoai);
        if (type != 0) {
    ...
    private void initUI(View view) {
        rcv_loaisach = view.findViewById(R.id.rcv_loai);
        btn_add = view.findViewById(R.id.flb_themloai);
    }
