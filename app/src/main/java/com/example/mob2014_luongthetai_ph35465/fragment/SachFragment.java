...
import com.example.mob2014_luongthetai_ph35465.adapter.LoaiSachSpinnerAdapter;
import com.example.mob2014_luongthetai_ph35465.adapter.SachAdapter;
...
public class SachFragment extends Fragment {
    ...
    protected void openDialog(final Context context, final int type) {
        ...
        edt_maSach = dialog.findViewById(R.id.txtMaSach);
        edt_tenSach = dialog.findViewById(R.id.txtTenSach);
        edt_giaThue = dialog.findViewById(R.id.txtGiaThue);

        spinner_loaiSach = dialog.findViewById(R.id.sp_LoaiSach);
    ...
    private void initUI(View view) {
        ...
        btn_add = view.findViewById(R.id.flb_themSach);
    }
}